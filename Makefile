...
40image-6: 40image.o compress40.o uarray2b.o uarray2.o bitpack.o dct.o cvrgb.o \
	 packwords.o maptrans.o createpixmap.o
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)

testcompress: testcompress.o uarray2b.o uarray2.o bitpack.o
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)
